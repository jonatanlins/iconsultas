      ...
      <ul className="listWithPrice">
        <li>
          <Link to="especialidades/3216">
            <img
              src="../assets/brands/santa-efigenia.png"
              alt=""
              className="logo"
            />
            <div className="content">
              ...
              <p>
                <i className="icon-location" /> 3,5Km
              </p>
        ...
        <li>
          <Link to="especialidades/3216">
            <img
              src="../assets/brands/multmedica.png"
              alt=""
              className="logo"
            />
            <div className="content">
              ...
              <p>Maurício de Nassau</p>
              <p>
                <i className="icon-location" /> 4,0Km
              </p>
              <span className="price">A partir de R$250 ou Convênio</span>
            </div>
          </Link>
        ...
        <li>
          <Link to="especialidades/3216">
            <img
              src="../assets/brands/maria-gertrudes.png"
              alt=""
              className="logo"
            />
            <div className="content">
              ...
              <p>Boa Vista 2</p>
              <p>
                <i className="icon-location" /> 6,5Km
              </p>
