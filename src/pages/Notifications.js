      ...
      <ul className="notificationList">
        <li>
          <a href="">
            ...
            <span className="content">
              Sua consulta com <b>Dr. Rodrigo Arruda</b> foi confirmada, confira
              os detalhes.
            </span>
          </a>
        </li>
        <li>
          <a href="">
            ...
            <span className="content">
              Sua consulta com <b>Dr. Rodrigo Arruda</b> teve uma alteração,
              confira os detalhes.
            </span>
          </a>
        </li>
        ...
        <li>
          <a href="">
            ...
            <span className="content">
              Olá <b>Felipe</b>, a <b>Droga Rocha</b> enviou uma oferta para
              você, confira!
            </span>
          </a>
        </li>
